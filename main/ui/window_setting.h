...
struct WindowSettings
{
    ...
    uint32_t highlightedBGColor        = 0x808080;
    uint32_t borderColor               = 0x303030;
    uint32_t frameColor                = 0x000000;
    uint32_t scrollBarBGColor          = 0x101010;
    uint32_t scrollBarColor            = 0xa0a0a0;
    uint32_t dialogBGColor             = 0x404040;
    uint32_t dialogMessageColor        = 0xe0e0e0;
    uint32_t dialogButtonSelectColor   = 0xc08080;
