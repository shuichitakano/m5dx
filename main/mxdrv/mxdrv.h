...
typedef struct tagMXWORK_GLOBAL
{
    UWORD L001ba6;
    ULONG L001ba8;
    UBYTE volatile* L001bac; // 0x600byte work??
    UBYTE L001bb4[16];
    UBYTE L001df4;
    UBYTE L001df6[16];
    ...
    UBYTE volatile* L001e34; // mdxbuf
    UBYTE volatile* L001e38; // pdxbuf
    ULONG L00220c;
...
extern "C"
{
    ...
    DLLEXPORT
    int MXDRV_Start(void* mdxbuf_ptr,
                    int mdxbuf_size,
                    void* pdxbuf_ptr,
                    int pdxbuf_size);
    ...
    DLLEXPORT
    DWORD MXDRV_MeasurePlayTime(void* mdx,
                                DWORD mdxsize,
                                void* pdx,
                                DWORD pdxsize,
                                int loop,
